...
import { PerguntaFrequenteResponseDto } from './dto/pergunta-frequente-response.dto';
...
export class PerguntaFrequenteController {
  ...
  @ApiCreatedResponse({ type: PerguntaFrequenteResponseDto })
  @Post()
  ...
  @ApiOkResponse({ type: PerguntaFrequenteResponseDto, isArray: true })
  @Get()
  findAll() {
  ...
  @ApiOkResponse({ type: PerguntaFrequenteResponseDto })
  @Get(':id')
